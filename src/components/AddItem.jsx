...
const AddItem = () => {
    ...
    const validateForm = () => {
        ...
        if (isNaN(Number(formData.price)) || Number(formData.price) <= 0) errors.price = "Please enter a valid price";
        ...
        if (formData.images.length === 0) errors.images = "Please upload at least one image";
    ...
    return (
        <div className="py-8 px-4 sm:px-6 lg:px-8 w-[100vw]  dark:bg-gray-900 overflow-auto" style={{ height }}>
            ...
            >
                <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">List Your Product</h1>
                        ...
                        <motion.div variants={fadeIn} className="form-group">
                            ...
                            >
                                ...
                                {hostels.map((hostel, index) => (
                                    <option key={index} value={hostel}>{hostel.toUpperCase()}</option>
                                ))}
                            </select>
                            {formErrors.hostel && (
                            ...
                            {previewImages.length > 0 && (
                                <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-4">
                                    {previewImages.map((preview, index) => (
                                        <div key={index} className="relative h-24 bg-gray-100 dark:bg-gray-700 rounded-md overflow-hidden">
                                            <img
                                                src={preview}
                                                alt={`Preview ${index + 1}`}
                        ...
                        <motion.div variants={fadeIn} className="form-group">
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label htmlFor="termsAgreed" className="font-medium text-gray-700 dark:text-gray-300">
                                        I agree to the{" "}
                                        <button
                                            type="button"
                                    ...
                                    {formErrors.termsAgreed && (
                                        <p className="mt-1 text-sm text-red-500">{formErrors.termsAgreed}</p>
                                    )}
                                </div>
                            </div>
                        </motion.div>
                    ...
                    >
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Terms and Conditions</h3>
                                <button
                                    onClick={toggleTermsModal}
                            ...
                            <div className="prose dark:prose-invert max-w-none text-gray-800 dark:text-gray-200">
                                <ol className="list-decimal space-y-4">
                                    ...
                                    <li>
                                        ...
                                        <p>BITS Pilani Store acts solely as a classified listings service connecting buyers and sellers.</p>
                                        <p>All communications and transactions happen outside the platform. We do not:</p>
                                    ...
                                    <li>
                                        ...
                                        <h4 className="font-semibold mt-2">4.2 Prohibited Listings (Strict Ban)</h4>
                                        <ul className="list-disc pl-5">
                                    ...
                                    <li>
                                        ...
                                        <p>You agree to indemnify BITS Pilani Store for any issues arising from your usage.</p>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <p>Seller contact is shared only when you click to contact them or when the contact information is viewed.</p>
                                        <p>No tracking or storing of personal chats or payment info.</p>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <p>Terms may be updated anytime. Continued usage implies agreement to updated terms.</p>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul className="list-disc pl-5">
                                            ...
                                            <li>This platform is student-run and unaffiliated with BITS Pilani administration.</li>
                                        </ul>
                                        <p>By using BITS Pilani Store, you confirm you have read, understood, and agreed to these Terms.</p>
                                    </li>
                                </ol>
                            </div>
