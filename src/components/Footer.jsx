...
const Footer = () => {
    ...
    return (
        <div className='flex w-full justify-around h-16 shadow-[2px_2px_30px_2px_#878787] dark:shadow-[2px_2px_30px_2px_#000000] dark:bg-gray-900  items-center z-10'>
            <div className='flex flex-col items-center hover:scale-[1.2] duration-200 ease-in dark:text-white' onClick={() => navigate("/ ")}>
            ...
            <div className='flex flex-col items-center hover:scale-[1.2] duration-200 ease-in dark:text-white' onClick={() => navigate("/categories")}>
