...
export default function Navbar({ darktheme, setDarktheme, searchVal, setSearchVal }) {
    ...
    return (
        <div className='w-full h-14 items-center px-2 flex shadow-lg dark:bg-gray-800 justify-between relative'>
            ...
            {!showSearch && (
                <h1 className='text-[#2D4059] text-xl sm:text-2xl lg:text-3xl font-bold dark:text-white transition-colors duration-300 cursor-pointer' onClick={() => navigate('/')}>Bits Pawnshop</h1>
            )}
                ...
                <div className="flex items-center space-x-2 md:space-x-4">
                    ...
                    <div className='hidden md:flex items-center dark:bg-gray-600 rounded border-2 border-gray-200 dark:border-0 transition-colors duration-300'>
                        ...
                        <input
                            onChange={(e) => { console.log(searchVal); setSearchVal(e.target.value); }}
                            type="text"
                            className='outline-0 border-0 dark:bg-gray-600 dark:text-white px-2 py-1 transition-colors duration-300 md:w-52 lg:w-46 xl:w-74'
                            placeholder='Search...'
                        />
                    </div>
                    ...
                    <div className="relative" ref={campusDropdownRef}>
                        ...
                        >
                            ...
                            <IoIosArrowDown className={`ml-2 text-gray-500 dark:text-gray-300 transition-transform duration-300 ${showCampuses ? 'transform rotate-180' : ''}`} />
                        </button>
                                ...
                                <ul>
                                    {campuses.map((campus) => (
                                        <li
                                            ...
                                            className={`px-4 py-2 flex items-center justify-between cursor-pointer transition-colors duration-200 ${selectedCampus === campus
                    ...
                    <div className=" hidden lg:flex items-center cursor-pointer dark:text-white bg-gray-100 dark:bg-gray-700 p-1.5 rounded dark:hover:bg-gray-500 duration-100 ease-in" onClick={() => navigate('/add')}>

                        <IoAdd className='mr-2'></IoAdd>
                        <p>Sell Item</p>
                    </div>
                    <div className=" hidden lg:flex items-center cursor-pointer dark:text-white bg-gray-100 dark:bg-gray-700 p-1.5 rounded dark:hover:bg-gray-500 duration-100 ease-in" onClick={() => navigate('/categories')}>

                        <BiSolidCategory className='mr-2'></BiSolidCategory>
                        <p>Categories</p>
                    </div>
                    {/* Theme Toggle Button */}
                    <button
                    ...
                    <div className="relative cursor-pointer" ref={dropdownRef}>
                        <button
                            ...
                            className="p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 cursor-pointer"
                        >
